...
@section('contenido')
    ...
    <div class="row">
        ...
        <div class="col-12">
            <form action="{{ route('toursen.update', ['toursen' => $tour->id]) }}" method="post" enctype="multipart/form-data"
                ...
                <div class="row">
                    ...
                    {{-- <div class="col-lg-2">
                        ...
                        <select id="tour_id" name="tour_id" class="form-control form-control-sm">
                            @foreach ($es as $e)
                                @if (!$e->tour)
                                    <option value="{{ $e->id }}" {{ $e->id == $tour->tour_id ? 'selected' : '' }}>
                                        {{ $e->nombre }}
                                    </option>
                                @endif  
                            @endforeach
                    ...
                    <div class="col-lg-4 pt-3 pb-3">
                        ...
                        <input type="file" id="img" name="img" class="form-control" accept="image/*"
                            value="{{ $tour->img }}">
                        <p>Imagen actual:</p>
                        <img src="../../{{ $tour->img }}" width="320px"><br>
                    </div>
                    ...
                    <div class="col-lg-4 pt-3">
                        ...
                        <select name="categoria[]" id="categoria" class="form-control form-control-sm"
                            ...
                            <option value="hikes">Diarios</option>
                    ...
                    <div class="col-lg-4 pt-3">
                        <label for="clase" class="form-label">Clase: <small class="text-primary">(Img para
                                fondo)</small></label>
                                <select name="clase" id="clase" class="form-control form-control-sm" required>
                                    ...
                                    <option value="maras" {{ old('clase', $tour->clase) == 'maras' ? 'selected' : '' }}>Maras
                                        Moray</option>
                    ...
                    <div class="col-lg-6 pt-3">
                        ...
                        <select name="tour_id" id="tour_id" class="form-control form-control-sm" required>
                            ...
                            @foreach ($es as $e)
                                <option value="{{ $e->id }}"
                                    {{ $e->id == old('tour_id', $tour->tourEs->id) ? 'selected' : '' }}>
                                    {{ $e->nombre }}
                                </option>
                            @endforeach
                        </select>
                ...
                <a href="{{ route('toursen.index') }}" class="btn btn-sm btn-secondary mt-4">Cancelar</a>
