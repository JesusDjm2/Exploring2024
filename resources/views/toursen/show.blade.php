...
@section('content')
                        ...
                        @if (session('status'))
                            <div class="text-success mt-2" style="z-index:999; position: relative;">
                                <div class="text-center alert alert-success alert-dismissible fade show" role="alert">
                                    His message was sent successfully, we will respond as soon as possible.
    ...
    @auth
        <div class="edicion">
            <a href="/toursen/{{ $tour->id }}/edit" target="_blank">
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="card card-new" style="width: 18rem;">
                            ...
                            <div class="card-body text-center">
                                ...
                                <a href="{{ route('toursen.show', $tour->slug) }}" class="boton-card">More
                                    details</a>
                            </div>
                        </div>
                    </div>
