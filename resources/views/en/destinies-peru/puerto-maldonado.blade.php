...
@php $titulo='Puerto Maldonado, the heart of the Peruvian jungle' @endphp
@php $descripcion="This region, located in the southeast of Peru, keeps nature in its purest state. Trees that hug each other" @endphp
@php $keywords="Puerto maldonado, Puertomaldonadojungle,puerto maldonado peru" @endphp
