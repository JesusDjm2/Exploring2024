...
@php $titulo="Pisco, cradle of the flag and door of freedom" @endphp
@php $descripcion="Every year the landing of the liberating expedition under the command of General Don José de San Martín in the Bay of Paracas" @endphp
@php $keywords="Pisco, Pisco city, Pisco Peru, Pisco cradle of the flag Peru" @endphp
