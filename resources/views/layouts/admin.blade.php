    ...
    <div id="wrapper">
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="{{ route('index') }}">
                <img src="{{ asset('img/logo-exploring-peru-tours.png') }}" width="100%" alt="">
            </a>
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="{{ route('tourspt.index') }}">
                    <i class="fas fa-fw fa-wrench"></i>
                    <span>Tours Portugués</span>
                </a>
            </li>
            <hr class="sidebar-divider">
            <div class="sidebar-heading">
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#pt"
                    aria-expanded="false" aria-controls="pt">
                    <i class="fas fa-fw fa-language"></i>
                    <span>Blogs Portugués</span>
                </a>
                <div id="pt" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar"
                    style="">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="{{ route('ptags.index') }}">
                            Tags
                        </a>
                        <a class="collapse-item" href="{{ route('blogspt.index') }}">
                            Blogs
                        </a>
                    </div>
                </div>
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Copyright &copy; Made by <a href="https://www.facebook.com/DjmWebMaster" target="_blank"> DJM2</a></span>
                    </div>
                </div>
            </footer>
        </div>
