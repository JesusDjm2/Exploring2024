@extends('layouts.app')
@php $titulo='Puno, capital del folflere peruano' @endphp
@php $descripcion="Puno esta ubicado al sur de Perú, y tiene en su terrotorio al inmenso lago Titicaca" @endphp
@php $keywords="puno, puno peru, puno ciudad, puno isla uros" @endphp
                    ...
                    <div class="details">
                        <div class="location">
                            <p><a href="{{ route('inicio') }}">Inicio</a> / <a
                                    href="{{ route('destinosPeru') }}">Destinos</a> / <a>Puno</a>
                            </p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-10">
                    <h2 class="mb-3">Destinos en Puno:</h2>
                    <div class="row">
