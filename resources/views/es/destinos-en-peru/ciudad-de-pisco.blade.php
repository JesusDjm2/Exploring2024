@extends('layouts.app')
@php $titulo="Pisco, cuna de la bandera y puerta de la libertad" @endphp
@php $descripcion="Cada año se celebra con fervor patriótico el desembarco de la expedición libertadora al mando del general Don José de San Martín en la bahía de Paracas." @endphp
@php $keywords="Pisco, Pisco ciudad, Pisco Peru, Pisco cuna de la bandera de Peru" @endphp
@php $img="https://pachamamaspirit.com/img/panoramico/pisco-city-tourism.webp" @endphp
