@extends('layouts.app')
@php $titulo='Puerto Maldonado, el corazón de la jungla peruana' @endphp
@php $descripcion="Esta región, ubicada al sureste del Perú, guarda la naturaleza en su estado más puro. Árboles que se abrazan" @endphp
@php $keywords="Puerto maldonado, Puerto maldonado jungle,puerto maldonado peru" @endphp
@php $img="https://pachamamaspirit.com/img/panoramico/puerto-maldonado-peru.webp" @endphp
