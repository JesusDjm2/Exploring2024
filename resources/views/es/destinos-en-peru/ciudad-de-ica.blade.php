@extends('layouts.app')
@php $titulo="Ica, la ciudad del eterno sol" @endphp
@php $descripcion="Ica es considerada la tierra del sol eterno, aquella donde será difícil que despiertes para ver días grises ya que el astro rey no se cansa de..." @endphp
@php $keywords="Ica, ciudad de Ica, ica peru" @endphp
