@extends('layouts.app')
@php $titulo="Cusco - ombligo del mundo | Incas Peru" @endphp
@php $descripcion="Cusco fué la capital del imperio inca. Es considerada tambipen como la capital arqueológica de América." @endphp
@php $keywords="Cusco - ombligo del mundo | Incas Peru" @endphp
                    ...
                    <div class="details">
                        <div class="location">
                            <p><a href="{{ route('inicio') }}">Inicio</a> / <a
                                    href="{{ route('destinosPeru') }}">Destinos</a> / <a>Cusco</a>
                            </p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-10">
                    <h2 class="mb-4">"Destinos en Cusco"</h2>
                    <div class="row">
                        ...
                        <div class="accordion-item">
                            ...
                            <div id="flush-collapseOne" class="accordion-collapse collapse"
                                ...
                                <div class="accordion-body">
                                    ...
                                    pacha) y el mundo superior (Hanan pacha). <br><br>
                                    De este modo, la ciudad fue y es llamada el ombligo del mundo, en referencia al
                                    universo. Sin embargo, ninguna lengua
